...
@Autonomous(name="IMU20143_Right", group="Test")
//@Disabled
public class IMU20143_Right extends LinearOpMode {
    ...
    final static double ClawMin          = 0.3;
    final static double ClawMax          = 0.7;
...
//AUTONOMOUS PATH BUILDS////////////////////////////////////////////////////////////////////////////
        ...
        encoderStrafe(DRIVE_SPEED, -24, 5, 0, 5.0); // strafe left 24 inches, keep lift at 5 inches, keep claw closed.
        encoderSpin(TURN_SPEED, -90, 16, 10, 5.0); //  rotate 90 degrees counter clockwise, set lift to 16 inches, keep claw closed.
        encoderStrafe(DRIVE_SPEED, 41, 36, 0, 5.0); //strafe right 41 inches, set lift to 36 inches, keep claw closed.
        encoderDrive(DRIVE_SPEED, 4, 36, 0, 5.0); // move forward 4 inches, keep lift at 36 inches, keep claw closed.
        ...
        for (Recognition object : objectDetection) {
            if (object.getLabel().equals("Triangle")) { // Object 1 path
                encoderStrafe(DRIVE_SPEED, -12, 15, 1, 5.0); //strafe left 12 inches, set lift to 15 inches, keep claw open.
                ...
                encoderStrafe(DRIVE_SPEED, 41, 15, 1, 5.0); //strafe left 41 inches, set lift to 15 inches, keep claw open.
            }
        }
    }
