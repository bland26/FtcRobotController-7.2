...
public class Stinger extends LinearOpMode {
    public double COUNTS_PER_MOTOR_REV;      // HD Hex Motor (Rev-41-1291) 20:1
    public double DRIVE_GEAR_REDUCTION;        // No External Gearing.
    public double WHEEL_DIAMETER_INCHES;     // 75mm Mechanum wheels
    public double COUNTS_PER_INCH;
    public double STRAFE_INCH_PER_REV;
    public double DEGREE_PER_REV;
    public double LIFT_INCH_PER_REV;

    // Claw variables

    public double ClawMin;
    public double ClawMax;
    public double ClawHome;


    // IMU correction constants
    public double     P_TURN_COEFF;     // Larger is more responsive, but also less stable
    public double     P_DRIVE_COEFF;     // Larger is more responsive, but also less stable
    ...
    final public String TFOD_MODEL_FILE  = "model_20221206_120301.tflite";
    ...
    public Stinger() {
        COUNTS_PER_MOTOR_REV = 528.65;    // HD Hex Motor (Rev-41-1291) 20:1
        DRIVE_GEAR_REDUCTION = 1.0;     // No External Gearing.
        WHEEL_DIAMETER_INCHES = 75 / 25.4;     // 75mm Mechanum wheels
    ...
    public void runOpMode() {
        ...
        Grippy = hardwareMap.get(Servo.class, "Grippy");
        digitalUp = hardwareMap.get(DigitalChannel.class, "digitalUp");
        digitalDown = hardwareMap.get(TouchSensor.class, "digitalDown");
